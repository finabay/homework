...
- Service must perform origin country resolution using a web service (you should find one) and store country code together with the loan application. Because network is unreliable and services tend to fail, let's agree on default country code - "lv".
